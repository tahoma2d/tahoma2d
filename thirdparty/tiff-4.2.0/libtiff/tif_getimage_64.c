...
int
TIFFReadRGBAStripExt_64(TIFF* tif, uint32 row, uint64 * raster, int stop_on_error)
...
int
TIFFReadRGBATileExt_64(TIFF* tif, uint32 col, uint32 row, uint64 * raster, int stop_on_error )
{
    char 	emsg[1024] = "";
    TIFFRGBAImage img;
    int 	ok;
