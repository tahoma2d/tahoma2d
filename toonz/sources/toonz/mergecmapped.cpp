...
public:
	...
	bool operator<(const MergedPair &p) const
	{
		...
		if (m_f1 != p.m_f1)
			return m_f1 < p.m_f1;
		if (m_aff.a11 != p.m_aff.a11)
			return m_aff.a11 < p.m_aff.a11;
		if (m_aff.a12 != p.m_aff.a12)
			return m_aff.a12 < p.m_aff.a12;
		if (m_aff.a13 != p.m_aff.a13)
			return m_aff.a13 < p.m_aff.a13;
		if (m_aff.a21 != p.m_aff.a21)
			return m_aff.a21 < p.m_aff.a21;
		if (m_aff.a22 != p.m_aff.a22)
			return m_aff.a22 < p.m_aff.a22;
		if (m_aff.a23 != p.m_aff.a23)
			return m_aff.a23 < p.m_aff.a23;
		return false;
	}
};
