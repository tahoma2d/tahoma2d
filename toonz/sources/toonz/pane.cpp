...
void TPanelTitleBarButtonForSafeArea::getSafeAreaNameList(QList<QString> &nameList)
{
...
TPanelTitleBar::TPanelTitleBar(QWidget *parent, TDockWidget::Orientation orientation)
