...
public:
	...
	static DragTool *makeLevelExtenderTool(XsheetViewer *viewer, bool invert = false);
	...
	static DragTool *makeKeyFrameHandleMoverTool(XsheetViewer *viewer, bool isEaseOut, int keyRow);
	static DragTool *makeNoteMoveTool(XsheetViewer *viewer);

	static DragTool *makeKeyOnionSkinMaskModifierTool(XsheetViewer *viewer, bool isFos);
	...
	static DragTool *makeSoundScrubTool(XsheetViewer *viewer, TXshSoundColumn *sc);
