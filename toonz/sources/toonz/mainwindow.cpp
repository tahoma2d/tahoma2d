...
void MainWindow::defineActions() {
  ...
  levelAction->setIcon(createQIcon("new_vector_level"));
  levelAction = createMenuLevelAction(MI_NewToonzRasterLevel,
                                      tr("&New Toonz Raster Level"), "");
  levelAction->setIcon(createQIcon("new_toonz_raster_level"));
  levelAction =
      createMenuLevelAction(MI_NewRasterLevel, tr("&New Raster Level"), "");
  levelAction->setIcon(createQIcon("new_raster_level"));
  levelAction = createMenuLevelAction(MI_LoadLevel, tr("&Load Level..."), "");
  levelAction->setIcon(createQIcon("load_level"));
  ...
  QAction *console = createMenuFileAction("MI_OpenScriptConsole",
                                          tr("Open Script Console..."), "");
  console->setIcon(createQIcon("console"));

  QAction *printCurrentFrame =
  ...
  about->setIconText(tr("About OpenToonz..."));
  ...
  createAction(MI_FillNextType, tr("Fill Tool - Next Type"), "",
               ToolCommandType);
  QAction *fillToolAction = createAction(
      MI_FillNormal, tr("Fill Tool - Normal"), "", ToolCommandType);
  fillToolAction->setIcon(createQIcon("fill_normal"));
  fillToolAction = createAction(
      MI_FillRectangular, tr("Fill Tool - Rectangular"), "", ToolCommandType);
