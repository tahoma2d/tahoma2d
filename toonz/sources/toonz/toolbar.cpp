	...
	: QToolBar(parent)
{
	...
	actionAdded = addAction(CommandManager::instance()->getAction(T_Selection)) || actionAdded;
	if (actionAdded)
		addSeparator();
	actionAdded = false;
	actionAdded = addAction(CommandManager::instance()->getAction(T_Brush)) || actionAdded;
	actionAdded = addAction(CommandManager::instance()->getAction(T_Geometric)) || actionAdded;
	actionAdded = addAction(CommandManager::instance()->getAction(T_Type)) || actionAdded;
	actionAdded = addAction(CommandManager::instance()->getAction(T_Fill)) || actionAdded;
	actionAdded = addAction(CommandManager::instance()->getAction(T_PaintBrush)) || actionAdded;
	if (actionAdded)
		addSeparator();
	actionAdded = false;
	actionAdded = addAction(CommandManager::instance()->getAction(T_Eraser)) || actionAdded;
	actionAdded = addAction(CommandManager::instance()->getAction(T_Tape)) || actionAdded;
	actionAdded = addAction(CommandManager::instance()->getAction(T_Finger));
	if (actionAdded)
		addSeparator();
	actionAdded = false;
	actionAdded = addAction(CommandManager::instance()->getAction(T_StylePicker)) || actionAdded;
	actionAdded = addAction(CommandManager::instance()->getAction(T_RGBPicker)) || actionAdded;
	...
	actionAdded = addAction(CommandManager::instance()->getAction(T_Bender)) || actionAdded;
	actionAdded = addAction(CommandManager::instance()->getAction(T_Iron)) || actionAdded;
	actionAdded = addAction(CommandManager::instance()->getAction(T_Cutter)) || actionAdded;
	if (actionAdded)
		m_sep1 = addSeparator();
	actionAdded = false;
	actionAdded = addAction(CommandManager::instance()->getAction(T_Skeleton)) || actionAdded;
	actionAdded = addAction(CommandManager::instance()->getAction(T_Hook)) || actionAdded;
	actionAdded = addAction(CommandManager::instance()->getAction(T_Tracker)) || actionAdded;
	actionAdded = addAction(CommandManager::instance()->getAction(T_Plastic)) || actionAdded;
	if (actionAdded)
		m_sep2 = addSeparator();
	actionAdded = false;
	actionAdded = addAction(CommandManager::instance()->getAction(T_Zoom)) || actionAdded;
	if (actionAdded)
		CommandManager::instance()->getAction(T_Zoom)->setChecked(true);
	actionAdded = addAction(CommandManager::instance()->getAction(T_Rotate)) || actionAdded;
	actionAdded = addAction(CommandManager::instance()->getAction(T_Hand)) || actionAdded;
...
{
	connect(TApp::instance()->getCurrentTool(), SIGNAL(toolSwitched()), SLOT(onToolChanged()));
}
