...
/*!
  ...
  Interaction methods such as mouse events also return a boolean to specify whether
...
public:
	...
	virtual bool mouseMoveEvent(SceneViewer *viewer, QMouseEvent *me) { return true; }
	virtual bool mouseReleaseEvent(SceneViewer *viewer, QMouseEvent *me) { return true; }
...
public:
	...
	void setEditingCameraInterestRect(const TRect &rect) { m_editingInterestRect = rect; }
