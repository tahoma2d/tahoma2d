...
public:
	...
	void select(const TPaletteP &palette, int pageIndex, int styleIndexInPage, bool on);
	bool isSelected(const TPaletteP &palette, int pageIndex, int styleIndexInPage) const;
