...
CleanupSwatch::CleanupSwatchArea::CleanupSwatchArea(CleanupSwatch *parent, bool isLeft)
...
bool CleanupSwatch::isEnabled()
{
	return isVisible() && m_enabled;
}
...
void CleanupSwatch::updateCleanupped()
{
	m_rightSwatch->updateRaster();
}
