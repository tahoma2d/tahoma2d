...
void onChange(TRaster32P &rasIn, const TRaster32P &rasOut, TPixel32 col, int _intensity)
{
...
void LinesFadePopup::onLinesColorChanged(const TPixel32 &color, bool isDragging)
{
