...
LineEdit *create(QGridLayout *layout, const QString &name, int &row, bool readOnly = true)
{
	...
	: QFrame(parent)
{
	...
	connect(m_processWith, SIGNAL(currentIndexChanged(int)), this, SLOT(onProcessWith(int)));
