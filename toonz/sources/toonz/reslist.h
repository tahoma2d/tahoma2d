...
//! The ResListManager is a \a singleton class which manages presets of camera resolutions.
/*!
  This class allows a lightweight management of the resolution presets used in camera settings.
  Specific tasks include resolution fetching and the add/remove functions. Adding or removing
