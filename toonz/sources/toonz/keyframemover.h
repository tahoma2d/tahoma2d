...
public:
	...
	enum Qualifier {
		eCopyKeyframes = 0x1, // leaves a copy of Keyframes block at the starting point
		eMoveKeyframes = 0x2, // move keyframes only (if the destination keyframes are empty)
