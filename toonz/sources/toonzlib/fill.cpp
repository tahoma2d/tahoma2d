...
bool fill(const TRasterCM32P &r, const FillParameters &params, TTileSaverCM32 *saver)
{
...
void fill(const TRaster32P &ras, const TRaster32P &ref, const FillParameters &params, TTileSaverFullColor *saver)
{
