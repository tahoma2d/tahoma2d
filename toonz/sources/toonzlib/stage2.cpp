...
void CameraTestCheck::setIsEnabled(bool on)
{
	...
	if (m_toggle->isChecked() != on)
		m_toggle->trigger(); // Please, note that this is different than using setEnabled(bool)
}

//-----------------------------------------------------------------------------

void CameraTestCheck::setToggle(QAction *toggle)
{
	m_toggle = toggle;
}
...
void CleanupPreviewCheck::setToggle(QAction *toggle)
{
	m_toggle = toggle;
}
...
void SetScanCropboxCheck::setToggle(QAction *toggle)
{
	m_toggle = toggle;
}
