...
public:
	...
	inline void repairDegenerations(const std::vector<ContourNode *> &degenerates);
...
inline void VectorizationContext::repairDegenerations(const std::vector<ContourNode *> &degenerates)
{
	unsigned int i;
...
SkeletonGraph *skeletonize(ContourFamily &regionContours, VectorizationContext &context,
						   VectorizerCore *thisVectorizer)
{
