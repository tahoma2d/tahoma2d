...
static TUINT64 _mask8_0 = 0x0102040810204080LL;

static TUINT64 _mask16_1 = 0x0101020204040808LL;
static TUINT64 _mask16_0 = 0x1010202040408080LL;

static TUINT64 _mask24_2 = 0x0101010202020404LL;
static TUINT64 _mask24_1 = 0x0408080810101020LL;
static TUINT64 _mask24_0 = 0x2020404040808080LL;

static TUINT64 _mask32_3 = 0x0101010102020202LL;
static TUINT64 _mask32_2 = 0x0404040408080808LL;
static TUINT64 _mask32_1 = 0x1010101020202020LL;
static TUINT64 _mask32_0 = 0x4040404080808080LL;

static TUINT64 _mask48_5 = 0x0101010101010202LL;
static TUINT64 _mask48_4 = 0x0202020204040404LL;
static TUINT64 _mask48_3 = 0x0404080808080808LL;
static TUINT64 _mask48_2 = 0x1010101010102020LL;
static TUINT64 _mask48_1 = 0x2020202040404040LL;
static TUINT64 _mask48_0 = 0x4040808080808080LL;

static TUINT64 _const4 = 0x0000000000FFFFFFLL;
//static TUINT64 _const5 = 0x000000FFFFFF0000LL;     // NOT USED
static TUINT64 _const6 = 0x00000000000000FFLL;
	...
	png_do_read_interlace(png_structp png_ptr)
{
	...
	if (row != NULL && row_info != NULL) {
		...
		{
#if 0
//          static TUINT64 _const4 = 0x0000000000FFFFFFLL;  no good
//          static TUINT64 const4 = 0x0000000000FFFFFFLL;   no good
//          TUINT64 _const4 = 0x0000000000FFFFFFLL;         no good
//          TUINT64 const4 = 0x0000000000FFFFFFLL;          no good
#endif
			png_bytep sptr, dp;
			png_uint_32 i;
...
// doesn't work           "i" (0x0000000000FFFFFFLL)   // %1 (a.k.a. _const4)
		...
		row_info->rowbytes = ((final_width *
								   (png_uint_32)row_info->pixel_depth +
							   7) >>
							  3);
	}
...
#define UseMMX_paeth 1 // GRR:  converted 20000828
	...
	png_debug1(0, "row=0x%08lx, ", (TUINT32)row);
