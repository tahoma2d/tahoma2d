...
PliObjectTag::PliObjectTag(const Type type)
	: PliTag(type)
{
}
...
PliGeometricTag::PliGeometricTag()
	: PliObjectTag()
{
}
...
PliGeometricTag::PliGeometricTag(const Type type)
	: PliObjectTag(type)
{
}
...
TextTag::TextTag()
	: PliObjectTag(PliTag::TEXT), m_text()
{
}
...
PaletteTag::PaletteTag(const PaletteTag &paletteTag)
	: PliTag(PliTag::PALETTE)
{
	...
	if (m_numColors == 0)
		...
		m_color = new TPixelRGBM32[m_numColors];
		for (UINT i = 0; i < m_numColors; i++)
			m_color[i] = paletteTag.m_color[i];
	}
}
...
BitmapTag::BitmapTag(const TRaster32P &r)
	: m_r(r)
{
}
...
BitmapTag::BitmapTag(const BitmapTag &bitmap)
	: m_r(bitmap.m_r)
{
}
...
StrokeOutlineOptionsTag::StrokeOutlineOptionsTag(const TStroke::OutlineOptions &options)
	: PliObjectTag(OUTLINE_OPTIONS_GOBJ), m_options(options) {}

/*=====================================================================*/

PrecisionScaleTag::PrecisionScaleTag()
	: PliObjectTag(PRECISION_SCALE_GOBJ) {}
...
GeometricTransformationTag::GeometricTransformationTag()
	: PliGeometricTag(PliTag::GEOMETRIC_TRANSFORMATION_GOBJ), m_affine(), m_object(NULL)
{
}

/*=====================================================================*/

GeometricTransformationTag::GeometricTransformationTag(const GeometricTransformationTag &trasformationTag)
	: PliGeometricTag(PliTag::GEOMETRIC_TRANSFORMATION_GOBJ), m_affine(trasformationTag.m_affine), m_object(trasformationTag.m_object)
{
}

/*=====================================================================*/

GeometricTransformationTag::GeometricTransformationTag(const TAffine &affine, PliGeometricTag *object)
	: PliGeometricTag(PliTag::GEOMETRIC_TRANSFORMATION_GOBJ), m_affine(affine), m_object(object)
{
}
...
DoublePairTag::DoublePairTag(const DoublePairTag &doublePairTag)
	: PliObjectTag(PliTag::DOUBLEPAIR_OBJ), m_first(doublePairTag.m_first), m_second(doublePairTag.m_second)
{
}
