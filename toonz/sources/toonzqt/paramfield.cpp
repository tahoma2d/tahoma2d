...
PointParamField::PointParamField(QWidget *parent, QString name, const TPointParamP &param)
...
PixelParamField::PixelParamField(QWidget *parent, QString name, const TPixelParamP &param)
...
EnumParamField::EnumParamField(QWidget *parent, QString name, const TIntEnumParamP &param)
...
void EnumParamField::setParam(const TParamP &current, const TParamP &actual, int frame)
{
...
BoolParamField::BoolParamField(QWidget *parent, QString name, const TBoolParamP &param)
	: ParamField(parent, name, param)
{
	QString str;
	m_paramName = str.fromStdString(param->getName());
...
void BoolParamField::setParam(const TParamP &current, const TParamP &actual, int frame)
{
	m_currentParam = current;
	m_actualParam = actual;
	assert(m_currentParam);
...
IntParamField::IntParamField(QWidget *parent, QString name, const TIntParamP &param)
	: ParamField(parent, name, param)
{
	QString str;
	m_paramName = str.fromStdString(param->getName());
...
void IntParamField::setParam(const TParamP &current, const TParamP &actual, int frame)
{
	m_currentParam = current;
	m_actualParam = actual;
	assert(m_currentParam);
...
StringParamField::StringParamField(QWidget *parent, QString name, const TStringParamP &param)
	: ParamField(parent, name, param)
{
	QString str;
	m_paramName = str.fromStdString(param->getName());
...
void StringParamField::setParam(const TParamP &current, const TParamP &actual, int frame)
{
	m_currentParam = current;
	m_actualParam = actual;
	assert(m_currentParam);
...
ParamField *ParamField::create(QWidget *parent, QString name, const TParamP &param)
{
...
// LineEdit_double
//
LineEdit_double::LineEdit_double(QWidget *parent, QString name, TDoubleParamP const &param)
...
void LineEdit_double::setParam(TParamP const &current, TParamP const &actual, int frame)
{
	current_ = current;
	actual_ = actual;
	update(frame);
...
// Slider_double
//
Slider_double::Slider_double(QWidget *parent, QString name, TDoubleParamP const &param)
	: ParamField(parent, name, param)
{
	m_paramName = QString::fromStdString(param->getName());
...
void Slider_double::setParam(TParamP const &current, TParamP const &actual, int frame)
{
	current_ = current;
	actual_ = actual;
	update(frame);
...
// SpinBox_double
//
SpinBox_double::SpinBox_double(QWidget *parent, QString name, TDoubleParamP const &param)
	: ParamField(parent, name, param)
{
	m_paramName = QString::fromStdString(param->getName());
...
void SpinBox_double::setParam(TParamP const &current, TParamP const &actual, int frame)
{
	current_ = current;
	actual_ = actual;
	update(frame);
...
// LineEdit_int
//
LineEdit_int::LineEdit_int(QWidget *parent, QString name, TIntParamP const &param)
	: ParamField(parent, name, param)
{
	m_paramName = QString::fromStdString(param->getName());
...
void LineEdit_int::setParam(TParamP const &current, TParamP const &actual, int frame)
{
	current_ = current;
	actual_ = actual;
	update(frame);
...
void Slider_int::setParam(TParamP const &current, TParamP const &actual, int frame)
{
	current_ = current;
	actual_ = actual;
	update(frame);
...
void SpinBox_int::setParam(TParamP const &current, TParamP const &actual, int frame)
{
	current_ = current;
	actual_ = actual;
	update(frame);
...
// CheckBox_bool
//
CheckBox_bool::CheckBox_bool(QWidget *parent, QString name, TBoolParamP const &param)
	: ParamField(parent, name, param)
{
	m_paramName = QString::fromStdString(param->getName());
...
void CheckBox_bool::setParam(TParamP const &current, TParamP const &actual, int frame)
{
	current_ = current;
	actual_ = actual;
	update(frame);
...
// RadioButton_enum
//
RadioButton_enum::RadioButton_enum(QWidget *parent, QString name, TIntEnumParamP const &param)
	: ParamField(parent, name, param)
{
	m_paramName = QString::fromStdString(param->getName());
...
void RadioButton_enum::setParam(TParamP const &current, TParamP const &actual, int frame)
{
	current_ = current;
	actual_ = actual;
	update(frame);
...
// ComboBox_enum
//
ComboBox_enum::ComboBox_enum(QWidget *parent, QString name, TIntEnumParamP const &param)
	: ParamField(parent, name, param)
{
	m_paramName = QString::fromStdString(param->getName());
...
void ComboBox_enum::setParam(TParamP const &current, TParamP const &actual, int frame)
{
	current_ = current;
	actual_ = actual;
	update(frame);
...
// LineEdit_string
//
LineEdit_string::LineEdit_string(QWidget *parent, QString name, TStringParamP const &param)
	: ParamField(parent, name, param), frame_(0)
{
	m_paramName = QString::fromStdString(param->getName());
...
void LineEdit_string::setParam(TParamP const &current, TParamP const &actual, int frame)
{
	current_ = current;
	actual_ = actual;
	update(frame);
...
ParamField *make_radiobutton(QWidget *parent, QString name, TParamP const &param)
{
	if (0)
		;
