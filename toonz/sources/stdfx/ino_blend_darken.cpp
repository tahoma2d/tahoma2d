...
class ino_blend_darken : public TBlendForeBackRasterFx
{
...
void ino_blend_darken::computeUpAndDown(
...
void ino_blend_darken::dryComputeUpAndDown(
...
void ino_blend_darken::doCompute(
	TTile &tile, double frame, const TRenderSettings &rs)
{
	/* ------ 画像生成 ---------------------------------------- */
