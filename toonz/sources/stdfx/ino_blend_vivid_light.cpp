...
class ino_blend_vivid_light : public TBlendForeBackRasterFx
{
...
void ino_blend_vivid_light::computeUpAndDown(
...
void ino_blend_vivid_light::dryComputeUpAndDown(
...
void ino_blend_vivid_light::doCompute(
	TTile &tile, double frame, const TRenderSettings &rs)
{
	/* ------ 画像生成 ---------------------------------------- */
