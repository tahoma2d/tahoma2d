...
class ino_blend_linear_dodge : public TBlendForeBackRasterFx
{
...
void ino_blend_linear_dodge::computeUpAndDown(
...
void ino_blend_linear_dodge::dryComputeUpAndDown(
...
void ino_blend_linear_dodge::doCompute(
	TTile &tile, double frame, const TRenderSettings &rs)
{
	/* ------ 画像生成 ---------------------------------------- */
