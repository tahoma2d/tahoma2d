...
class ino_blend_cross_dissolve : public TBlendForeBackRasterFx
{
...
void ino_blend_cross_dissolve::computeUpAndDown(
...
void ino_blend_cross_dissolve::dryComputeUpAndDown(
...
void ino_blend_cross_dissolve::doCompute(
	TTile &tile, double frame, const TRenderSettings &rs)
{
	/* ------ 画像生成 ---------------------------------------- */
