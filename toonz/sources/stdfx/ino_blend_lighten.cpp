...
class ino_blend_lighten : public TBlendForeBackRasterFx
{
...
void ino_blend_lighten::computeUpAndDown(
...
void ino_blend_lighten::dryComputeUpAndDown(
...
void ino_blend_lighten::doCompute(
	TTile &tile, double frame, const TRenderSettings &rs)
{
	/* ------ 画像生成 ---------------------------------------- */
