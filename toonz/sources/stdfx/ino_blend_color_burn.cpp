...
class ino_blend_color_burn : public TBlendForeBackRasterFx
{
...
void ino_blend_color_burn::computeUpAndDown(
...
void ino_blend_color_burn::dryComputeUpAndDown(
...
void ino_blend_color_burn::doCompute(
	TTile &tile, double frame, const TRenderSettings &rs)
{
	/* ------ 画像生成 ---------------------------------------- */
