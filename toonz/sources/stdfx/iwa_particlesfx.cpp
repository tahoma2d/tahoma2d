...
void Iwa_TiledParticlesFx::getParamUIs(TParamUIConcept *&concepts, int &length)
{
...
bool Iwa_TiledParticlesFx::doGetBBox(double frame, TRectD &bBox, const TRenderSettings &info)
{
