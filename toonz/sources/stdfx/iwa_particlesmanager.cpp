...
DEFINE_CLASS_CODE(Iwa_ParticlesManager::FxData, 170) /*- 注：ParticlesManager::FxDataは110 -*/
...
Iwa_ParticlesManager::FrameData::~FrameData()
{
	m_fxData->release();
}
...
Iwa_ParticlesManager::FrameData *Iwa_ParticlesManager::data(unsigned long fxId)
{
