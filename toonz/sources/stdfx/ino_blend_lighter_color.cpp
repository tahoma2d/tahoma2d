...
class ino_blend_lighter_color : public TBlendForeBackRasterFx
{
...
void ino_blend_lighter_color::computeUpAndDown(
...
void ino_blend_lighter_color::dryComputeUpAndDown(
...
void ino_blend_lighter_color::doCompute(
	TTile &tile, double frame, const TRenderSettings &rs)
{
	/* ------ 画像生成 ---------------------------------------- */
