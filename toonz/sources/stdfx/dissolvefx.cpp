...
void doDissolve(const TRasterPT<PIXEL> &ras, const double intensity, TRandom &rnd)
{
...
void DissolveFx::doCompute(TTile &tile, double frame, const TRenderSettings &ri)
{
	if (!m_input.isConnected())
		return;
