...
class ino_blend_linear_burn : public TBlendForeBackRasterFx
{
...
void ino_blend_linear_burn::computeUpAndDown(
...
void ino_blend_linear_burn::dryComputeUpAndDown(
...
void ino_blend_linear_burn::doCompute(
	TTile &tile, double frame, const TRenderSettings &rs)
{
	/* ------ 画像生成 ---------------------------------------- */
