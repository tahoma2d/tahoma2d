...
void doDiamondGradient(const TRasterPT<PIXEL> &ras, const TSpectrumT<PIXEL> &spectrum, TPointD &tilepos, double size)
{
...
void DiamondGradientFx::doCompute(TTile &tile, double frame, const TRenderSettings &ri)
{
