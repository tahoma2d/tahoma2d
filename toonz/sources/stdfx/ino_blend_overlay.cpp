...
class ino_blend_overlay : public TBlendForeBackRasterFx
{
...
void ino_blend_overlay::computeUpAndDown(
...
void ino_blend_overlay::dryComputeUpAndDown(
...
void ino_blend_overlay::doCompute(
	TTile &tile, double frame, const TRenderSettings &rs)
{
	/* ------ 画像生成 ---------------------------------------- */
