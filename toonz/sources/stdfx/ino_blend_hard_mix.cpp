...
class ino_blend_hard_mix : public TBlendForeBackRasterFx
{
...
void ino_blend_hard_mix::computeUpAndDown(
...
void ino_blend_hard_mix::dryComputeUpAndDown(
...
void ino_blend_hard_mix::doCompute(
	TTile &tile, double frame, const TRenderSettings &rs)
{
	/* ------ 画像生成 ---------------------------------------- */
