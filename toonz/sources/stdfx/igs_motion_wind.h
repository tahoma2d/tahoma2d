...
IGS_MOTION_WIND_EXPORT void change(
	...
	,
	const double length_min = 0.0, const double length_max = 18.0, const double length_bias = 0.0 // ...-1.0...0.0...1.0..
	,
	...
	,
	const double force_min = 0.0, const double force_max = 1.0, const double force_bias = 0.0 // ...-1.0...0.0...1.0..
	,
	...
	,
	const double density_min = 0.0, const double density_max = 1.0, const double density_bias = 0.0 // ...-1.0...0.0...1.0..
	,
