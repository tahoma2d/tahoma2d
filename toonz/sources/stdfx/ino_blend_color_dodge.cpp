...
class ino_blend_color_dodge : public TBlendForeBackRasterFx
{
...
void ino_blend_color_dodge::computeUpAndDown(
...
void ino_blend_color_dodge::dryComputeUpAndDown(
...
void ino_blend_color_dodge::doCompute(
	TTile &tile, double frame, const TRenderSettings &rs)
{
	/* ------ 画像生成 ---------------------------------------- */
