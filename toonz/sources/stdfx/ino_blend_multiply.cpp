...
class ino_blend_multiply : public TBlendForeBackRasterFx
{
...
void ino_blend_multiply::computeUpAndDown(
...
void ino_blend_multiply::dryComputeUpAndDown(
...
void ino_blend_multiply::doCompute(
	TTile &tile, double frame, const TRenderSettings &rs)
{
	/* ------ 画像生成 ---------------------------------------- */
