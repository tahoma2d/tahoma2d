...
class ino_blend_screen : public TBlendForeBackRasterFx
{
...
void ino_blend_screen::computeUpAndDown(
...
void ino_blend_screen::dryComputeUpAndDown(
...
void ino_blend_screen::doCompute(
	TTile &tile, double frame, const TRenderSettings &rs)
{
	/* ------ 画像生成 ---------------------------------------- */
