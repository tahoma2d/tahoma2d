...
TParamChange::TParamChange(TParam *param,
						   double firstAffectedFrame, double lastAffectedFrame,
						   bool keyframeChanged, bool dragging, bool undoing)
	: m_param(param), m_firstAffectedFrame(firstAffectedFrame), m_lastAffectedFrame(lastAffectedFrame), m_keyframeChanged(keyframeChanged), m_dragging(dragging), m_undoing(undoing)
{
}
