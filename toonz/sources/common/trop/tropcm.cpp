...
void addColor(TPaletteP plt, int index, const TPaletteP &upPlt, std::map<int, int> &usedInks)
{
		...
		while (pixDown < endPix) {
			...
			if (!pixUp->isPurePaint()) {
				...
				if (val == 1) { //Matchline is on top, with gap
					...
					if ((val > 0 && toneUp < toneDown) || (val == 0 && toneDown == 255)) //(toneUp<toneDown)
						pixDown->setTone(toneUp);
...
void addColors(const TPixelCM32 &color, TPaletteP plt, const TPaletteP &upPlt, std::map<int, int> &usedColors)
{
...
//---------------------------------------------------------------------------
void addColors(const TPixelCM32 &color, TPaletteP plt, std::map<int, int> &usedColors)
{
	if (usedColors.find(color.getInk()) == usedColors.end())
...
void TRop::eraseColors(TRasterCM32P ras, vector<int> &colorIds, bool eraseInks, bool keepColor)
{
	assert(ras);
...
//--------------------------------
/*
void TRop::overaCmapped(TRasterCM32P rasOut, const TRasterCM32P& rasUp, const TPaletteP &pltOut, int matchlinePrevalence, std::map<int,int>& usedColors)
{
...
void TRop::applyMatchLines(TRasterCM32P rasOut, const TRasterCM32P &rasUp, const TPaletteP &pltOut, int inkIndex, int matchlinePrevalence, std::map<int, int> &usedInks)
{
...
void TRop::overlayCmapped(TRasterCM32P rasOut, const TRasterCM32P &rasUp, const TPaletteP &pltOut, const TPaletteP &upPlt, std::map<int, int> &usedColors)
{
