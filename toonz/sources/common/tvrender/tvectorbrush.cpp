...
void makeCenterline(const TStroke &path, const TEdge &edge, const TRectD &regionBox,
...
void TOutlineUtil::makeOutline(const TStroke &path, const TRegion &region, const TRectD &regionBox,
