...
void DragSelectionTool::UndoRasterTransform::setChangedValues()
{
	...
	RasterSelection *selection = dynamic_cast<RasterSelection *>(m_tool->getSelection());
...
void DragSelectionTool::RasterDeformTool::applyTransform(TAffine aff, bool modifyCenter)
{
	...
	RasterSelection *rasterSelection = dynamic_cast<RasterSelection *>(getTool()->getSelection());
...
void RasterSelectionTool::transformFloatingSelection(const TAffine &affine, const TPointD &center,
