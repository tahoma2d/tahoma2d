...
//=============================================================================
/*! \brief The DoubleValuePairField class provides to view an object to manage a pair
					 of double parameter.

		Inherits \b QWidget.

		The object is composed of an horizontal layout \b QHBoxLayout which contains
		two pair [label, text field] and a slider with two grab, one for each double
		value to manage. [label, text field] are a \b QLabel and a \b DoubleLineEdit.
		...
		To know when one of two double parameter value change class provides a signal,
