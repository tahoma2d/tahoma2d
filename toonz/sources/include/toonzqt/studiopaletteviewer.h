...
//=============================================================================
//!	The StudioPaletteTreeViewer class provides an object to view and manage palettes files.
/*!	Inherits \b QTreeWidget, \b StudioPalette::Listener and \b ProjectManager::Listener.
...
public:
	...
	TXshLevelHandle *getCurrentLevelHandle() const { return m_currentLevelHandle; }
...
protected:
	...
	/*! Return true if \b item match with Studio Palette or Cleanup Palette folder. */
...
//=============================================================================
//!	The StudioPaletteViewer class provides an object to view and manage studio palettes.
/*!	Inherits \b QFrame.
