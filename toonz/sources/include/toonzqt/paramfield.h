...
public:
	...
	virtual void setParam(const TParamP &current, const TParamP &actual, int frame) = 0;

	virtual void update(int frame) = 0;

	static ParamField *create(QWidget *parent, QString name, const TParamP &param);
...
class DVAPI MeasuredDoubleParamField : public AnimatedParamField<double, TDoubleParamP>
{
	Q_OBJECT
...
class DVAPI MeasuredRangeParamField : public AnimatedParamField<DoublePair, TRangeParamP>
{
	Q_OBJECT
...
class DVAPI PixelParamField : public AnimatedParamField<TPixel32, TPixelParamP>
{
	Q_OBJECT
...
class DVAPI SpectrumParamField : public AnimatedParamField<TSpectrum, TSpectrumParamP>
{
	Q_OBJECT
...
class DVAPI ToneCurveParamField : public AnimatedParamField<const QList<TPointD>, TToneCurveParamP>
{
	Q_OBJECT
