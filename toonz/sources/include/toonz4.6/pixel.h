...
#define PIX_RGB16_FROM_BYTES(R, G, B) (((R) << 8) & 0xf800 | ((G) << 3) & 0x7e0 | ((B) >> 3))
...
#define PIX_XRGB1555_FROM_BYTES(R, G, B) (((R) << 7) & 0x7c00 | ((G) << 2) & 0x3e0 | ((B) >> 3))
...
#define PIX_INIT_DITHER_RGBM64_TO_RGBM \
	tnz_random_seed(180461);
...
#define PIX_RGB_TO_GREY(X) (((UINT)((X).r) * 19594 + \
							 (UINT)((X).g) * 38472 + \
							 (UINT)((X).b) * 7470 +  \
							 (UINT)(1 << 15)) >>     \
							16)
