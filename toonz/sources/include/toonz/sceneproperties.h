...
public:
	...
	*/
	~TSceneProperties();
	/*!
		assign attributes of sprop to \e this and assign memory (makes new) for the cameras.
	*/
	void assign(const TSceneProperties *sprop);
	/*!
		It is called on new scene creation as it updates scanner parameters to current scanner.
	*/
	void onInitialize();
	/*!
		Returns horizontal Guides; a vector of double values that shows y-value of
		horizontal lines.
	*/
	Guides &getHGuides() { return m_hGuides; }
	/*!
		Returns vertical Guides; a vector of double values that shows x-value of
		vertical lines.
	*/
	...
	*/
	...
	/*!
		Returns a constant vector of pointer to \b TCamera with all camera in scene.
	*/
	...
	*/
	...
	/*!
		...
		This method is as above, but is called in the updates of the frame or of the sheet.
	*/
  ...
  */
	...
	*/
	...
	/*!
		Returns full-color images subsampling in scene. Subsampling value is the simplifying
