...
public:
	...
	// pixel ratio refers to graph panel. It is necessary to move along a circular arc
	...
	// (if a keyframe already exsist at frame then it is equivalent to selectKeyframe)
