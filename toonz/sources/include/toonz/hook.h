...
public:
  ...
  */
	...
	void setTrackerObjectId(int trackerObjectId) { m_trackerObjectId = trackerObjectId; }
...
public:
  ...
  */
	...
	//! Finds \b hook in the container, \a deletes it, and replaces its hook cell with 0.
...
public:
	...
	int getIndexFromId(int objectId); // return objectIndex, return -1 if objectId doesn't exist
