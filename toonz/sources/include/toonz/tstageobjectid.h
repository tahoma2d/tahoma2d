...
\n For each specialization you give to each stage object a sequential number.
   The class provides methods to get sequential number getIndex() and objectId name
   toString().
   It's possible to compare different stage object using defined operator, operator==(),
