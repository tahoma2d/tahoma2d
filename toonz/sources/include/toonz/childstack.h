...
/*!The class has a vector of \b ChildStack::Node, a pointer to current \b TXsheet
   ...
   properties, getAncestor(), getAncestorCount(), getAncestorAffine(), getTopXsheet().
*/
//=============================================================================
...
public:
  ...
  */
	...
	// NON USARE. Serve solo per un truccaccio sporchissimo in xshcolumnselection.cpp
