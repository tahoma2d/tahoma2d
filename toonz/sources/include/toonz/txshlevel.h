...
\n This is an abstract base class inherited by the concrete classes
   ...
   It's possible ot know level name, getName(), or identify level types getType(),
...
public:
  ...
  */
	...
	//! Method (to be overridden in subclasses) to downcast to \b TXshZeraryFxLevel
	...
	//! Method (to be overridden in subclasses) to downcast to \b TXshSoundTextLevel
