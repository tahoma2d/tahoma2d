...
template <typename Point>
inline typename point_traits<Point>::value_type operator*(const Point &a, const Point &b)
{
...
template <typename Point>
inline typename point_traits<Point>::value_type cross(const Point &a, const Point &b)
{
...
template <typename Point>
inline typename point_traits<Point>::value_type dist2(const Point &a, const Point &b)
{
	return norm2(b - a);
}
...
template <typename Point>
inline typename point_traits<Point>::value_type dist(const Point &a, const Point &b)
{
	return norm(b - a);
}
...
template <typename Point>
inline Point normalized(const Point &v, typename point_traits<Point>::value_type tol)
{
...
template <typename Point>
inline Point direction(const Point &a, const Point &b, typename point_traits<Point>::value_type tol)
{
...
template <typename Point>
typename point_traits<Point>::value_type segDist(const Point &a, const Point &b, const Point &p)
{
	Point v(b - a), w;
	v = v / norm(v);
