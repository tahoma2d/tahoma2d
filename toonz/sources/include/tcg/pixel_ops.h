...
inline void over_premult(Pix &down, const Pix &up, Scalar = 0)
{
	...
	pixel_traits<Pix>::r(down) = pixel_traits<Pix>::r(up) + t * pixel_traits<Pix>::r(down);
	pixel_traits<Pix>::g(down) = pixel_traits<Pix>::g(up) + t * pixel_traits<Pix>::g(down);
	pixel_traits<Pix>::b(down) = pixel_traits<Pix>::b(up) + t * pixel_traits<Pix>::b(down);
	pixel_traits<Pix>::m(down) = pixel_traits<Pix>::m(up) + t * pixel_traits<Pix>::m(down);
}
