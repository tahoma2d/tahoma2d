...
struct function<Ret (*)(Arg1, Arg2), f> : public std::binary_function<Arg1, Arg2, Ret> {
...
struct function<Ret (C::*)() const, f> : public std::unary_function<const C &, Ret> {
...
struct function<Ret (C::*)(Arg), f> : public std::binary_function<C &, Arg, Ret> {
...
struct function<Ret (C::*)(Arg) const, f> : public std::binary_function<const C &, Arg, Ret> {
