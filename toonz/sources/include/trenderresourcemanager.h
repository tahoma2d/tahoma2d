...
\note Resource managers may be constructed with a <i> render instance <\i> scope rather
...
public:
	...
	static std::vector<TRenderResourceManagerGenerator *> &generators(bool instanceScope);
...
\n \n
The dependencies declarations list is a sequence of static \c <DependencyResourceManager>::deps()
