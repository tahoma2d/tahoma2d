...
<li> The compute() method, which performs the effective calculation of the passed tile.
<li> The simCompute() method, which is a dummy simulation of the above compute(),
