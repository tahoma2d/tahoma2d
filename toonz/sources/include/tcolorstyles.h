...
private:
	...
	bool m_isEditedFromOriginal; //<! If the style is copied from studio palette, This flag will be set when the
...
public:
	...
	virtual TColorStyle &copy(const TColorStyle &other) //!< Polymorphic copy of the style.
	{
