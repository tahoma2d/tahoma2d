...
//
// inserisce i colori di sourcePalette individuati da sourceIndices in targetPalette
// per ogni colore prima cerca un colore identico (TColorStyle::operator==()) in targetPalette
