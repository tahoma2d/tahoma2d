...
function _updateVersion() {
	...
	sed -i "s/Description: Tahoma 2D Version $current_program_version/Description: Tahoma 2D Version $program_version/" "$control_file"
...
function _moveFiles() {
	...
	cp "/tmp/squashfs-root/usr/share/applications/org.tahoma2d.Tahoma2D.desktop" "$final_folder/usr/local/share/applications/org.tahoma2d.Tahoma2D.desktop"

	mkdir -p "$final_folder/usr/share/icons/hicolor/128x128/apps/"
	cp "/tmp/squashfs-root/usr/share/icons/hicolor/128x128/apps/org.tahoma2d.Tahoma2D.png" "$final_folder/usr/share/icons/hicolor/128x128/apps/org.tahoma2d.Tahoma2D.png"

	mkdir -p "$final_folder/usr/share/metainfo/"
	cp "/tmp/squashfs-root/usr/share/metainfo/org.tahoma2d.Tahoma2D.metainfo.xml" "$final_folder/usr/share/metainfo/org.tahoma2d.Tahoma2D.metainfo.xml"

	mkdir -p "$final_folder/etc/skel/.local/share/Tahoma2D/"
	cp "/tmp/squashfs-root/AppRun" "$final_folder/etc/skel/.local/share/Tahoma2D/AppRun"
}
