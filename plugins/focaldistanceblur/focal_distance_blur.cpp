...
extern "C" {
	TOONZ_PLUGIN_PROBE_BEGIN(TOONZ_IF_VER(1, 0))
		TOONZ_PLUGIN_PROBE_DEFINE(TOONZ_PLUGIN_VER(1, 0), "focal-distance-plugin" /* name */, "TomDoingArt" /* vendor */, "FocalDistanceBlur.plugin" /* identifier */, "Blur each level based on focal distance", "TBD", TOONZ_PLUGIN_CLASS_POSTPROCESS_SLAB | TOONZ_PLUGIN_CLASS_MODIFIER_GEOMETRIC, &toonz_plugin_node_handler0)
// ,
