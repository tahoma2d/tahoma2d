...
```
In Debian / Devuan: replace `libjpeg-turbo8-dev` with `libturbojpg0-dev` and `qt5-default` with `libqt5serialport5-dev` and add: `libsuperlu-dev liblz4-dev liblzo-dev libmypaint-dev`
