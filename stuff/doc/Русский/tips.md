# Добро пожаловать в Tahoma2D 1.6!

В версии 1.6 представлено множество новых функций, улучшений и еще больше исправлений, которые перечислены [здесь](https://github.com/tahoma2d/tahoma2d/releases/tag/v1.6).

### Изменения совместимости

- Расположение и порядок наложения маски обрезки изменилось. Теперь она должна располагаться над столбцом, который нужно обрезать, и располагаться в порядке снизу вверх/слева направо.
